...
class COCOCaption:
    ...
    def prepare(self, split):
        ...
        with open(self.save_path / f"coco_{split}.pkl", 'wb') as f:
            pickle.dump(data, f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--annot-path', type=str, default='data/dataset_coco.json')
    parser.add_argument('--dataset-path', type=str, default='C:\\Users\\sithu\\Documents\\Datasets\\COCO2014')
    parser.add_argument('--save-path', type=str, default='data/COCO')
